        ...
        <div class="row">
            <div class="col-md-5 offset-md-1">
                ...
                <form action="{{ route('checkout.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-success custom-border-success btn-block">Complete Order
                    </button>
                </form>
            </div>
            <div class="col-md-5 offset-md-1">
                ...
                @if (!session()->has('coupon'))
                    <form action="{{ route('coupon.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-success custom-border-success btn-block">Apply Coupon
                        </button>
                    </form>
                @endif
            </div>
